...
class ProtocoloViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['PUT'], url_path="changeStatusProtocol/(?P<pk>[^/.]+)/(?P<status>[^/.]+)/", url_name="changeStatusProtocol")
...
class ProyectoViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['PUT'], url_path="changeStatusProyect/(?P<pk>[^/.]+)/(?P<status>[^/.]+)/", url_name="changeStatusProyect")
    def changeState(self,request, pk, status):
        if request.method == 'PUT':
